"""
Kolo 2, krok 1: rozsireni exogennich kanalu.

Srovnava tri feature-sety - univariate / multivariate (kolo 1 "rozsirene") /
multivariate_plus (kolo 2, navic napeti U1-3, proud I1-3, ucinik PF, THDU1-3)
x modely (Persistence/SeasonalNaive24h/LightGBM/CatBoost/XGBoost), stejny
harness jako kolo 1 (vychozi hyperparametry, tuning az v dalsim kroku).

Vystup:
    prediction/srovnani_2/results_summary.csv     - MAE/RMSE/MAPE per (feature_set, model, mode)
    prediction/srovnani_2/results_by_horizon.csv  - MAE/RMSE per krok horizontu 1..96 (jen mode=24h)

Pouziti:
    python3 prediction/srovnani_2/run_comparison.py
"""
...
FEATURE_MODES = ["univariate", "multivariate", "multivariate_plus"]
