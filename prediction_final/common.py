"""
Sdilene jadro pro train.py + predict.py v teto slozce. Slozka `prediction_final`
je zamerne izolovana od zbytku repa (nezavisi na prediction/pipeline.py ani
prediction/best_model.py) - da se zkopirovat samostatne.

Feature-set a metodologie: viz prediction/EXPERIMENT_LOG.md "Kolo 2".
"""
